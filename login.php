...
if(isset($_REQUEST['submit']))
{
    ...
    setcookie("emailuser", $_REQUEST['email'], time()+(60*60*8));
    setcookie("passworduser", $_REQUEST['password'], time()+(60*60*8));  /* expire in 1 hour */
  } else {
    /**
     ...
     * */
    setcookie("emailuser", "",  time()+(60*60*8));
    setcookie("passworduser", "",  time()+(60*60*8));
  }
...
<head>
	<meta charset="utf-8" />
	<title>Online Task Managment System</title>
...
<div class="container">
  ...
  <div class="card">
				 ...
				 <form role="form" method="post" action="">
					...
					<div class="input-container">
					<input type="password" id="Password" required="required" value="<?php if(isset($_COOKIE["passworduser"])){ echo $_COOKIE["passworduser"];} ?>" name="password"/>
					...
					<div class="input-container2">
						 ...
						 <input name="remember" type="checkbox" <?php if(isset($_COOKIE["emailuser"])){ echo "checked";} ?>  value="remember"/>
					...
					<div class="button-container">
					                 ...
					                 <button type="submit" name="submit" value="LOG IN"><span> Login</span></button>
