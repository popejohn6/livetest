...
function get_fb_complete(){
    ...
    var feedback = $.ajax({
        ...
        async: false
         ...
         $('.chat').html(data);
        setTimeout(function(){get_fb_complete();}, 100);
    }).responseText;
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i> <?php echo $row['name']; ?> Profile</a>
                        </li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            <div class="input-group">
                                <input id="btn-input" type="text" name="chattext" class="form-control input-sm" placeholder="Type your message here..." />
                                <span class="input-group-btn">
                                    <button class="btn btn-warning btn-sm" id="btn-chat" onclick="datastore()">
                                        Send
                                    </button>
                                </span>
                            </div>
